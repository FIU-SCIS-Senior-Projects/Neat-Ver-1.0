...
class LoggedIn extends React.Component {
  ...
  render() {
    return (
      <TabNavigator>
        {this.renderTabItem('Assignments', Routes.getAssignmentsRoute(), images.icons.assignments)}
        {this.renderTabItem('Classes', Routes.getClassesRoute(), images.icons.classes)}
